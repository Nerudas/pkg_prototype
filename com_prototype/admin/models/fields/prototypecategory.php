...
class JFormFieldPrototypeCategory extends JFormFieldList
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since  1.0.0
	 */
	protected $type = 'prototypecategory';
	...
	protected function getOptions()
	{
		...
		// Prepare options
		$check     = false;
		$component = $app->input->get('option', 'com_prototype');
		$view      = $app->input->get('view', 'category');
		$id        = $app->input->getInt('id', 0);

		if ($app->isAdmin() && $component == 'com_prototype' && $view == 'category')
		{
			$check = true;
		}
