...
class PrototypeViewMap extends HtmlView
{
	/**
	 * Category object
	 *
	...
	public function display($tpl = null)
	{
		...
		$this->document->addScriptOptions('prototypeMap', $this->mapParams);
	...
	protected function _prepareDocument()
	{
		...
		if ($menu && ($menu->query['option'] !== 'com_prototype' || $menu->query['view'] !== 'map' || $id != $category->id))
		{
			if ($category->title)
			{
